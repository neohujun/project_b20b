...
extern void PrepareStartup(void);
...
#endif
#ifndef __BANKED__
  __asm JMP PrepareStartup; /* with a C style main(); we would push the return address on the stack wasting 2 RAM bytes */
#else
  __asm CALL PrepareStartup;
#endif
}

extern unsigned char isMcuUpdate;
extern unsigned char SystemReqState;
/**********************************************************************************************************************
**	Func Name:		void FlashWriteStartup(void)
**	Parameters:		void
**	Return Value:	void
**	Abstract:		flash write startup
**********************************************************************************************************************/
